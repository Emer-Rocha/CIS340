...
// This imports the componenets that we will be using to make sure that our App receives data from the Internet
...
class WeatherForecast extends Component {
  ...
  handleTextChange = event => { 
    ...
    open_weather_map.fetchForecast(zip).then(forecast => { this.setState({forecast:forecast})});
  }
